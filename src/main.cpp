...
//           << " for chunk: " << fields[1] << '\n';
    ...
    std::cout << "new delta compression ratio : " << ((1 - (static_cast<double>(totalDeltaSize) / (totalSize / 2))) * 100.0) << "%\n";
    std::cout << " gdelta dcr : " << ((1 - (static_cast<double>(gDeltaSize) / (totalSize/2))) * 100.0) << "%\n";
