...
double durationGdelta = 0.0;  // global duration for performance measurement
double durationDelta = 0.0;  // global duration for performance measurement

size_t totalSize = 0;

size_t totalGDeltaSize = 0;  // total size of all input chunks
size_t totalDeltaSize = 0;  // total size of all deltas
...
alignas(64) char lz4Buff[65536];  // 64K buffer for LZ4 compression
char* lz4ptr = lz4Buff; // pointer to the current position in the LZ4 buffer
